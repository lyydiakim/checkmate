/*Status:
    ...
    Doesn't work with duplicate entries
*/
...
function displayResults() { // used to clear and print the entire table based on dict elements
    ...
    const calculatedTotal = Object.values(itemsDict).reduce((acc, cur) => acc + cur, 0); // adding in calculated total
    const tr = document.createElement('tr');
    const td1 = document.createElement('td');
    const td2 = document.createElement('td');
    ...
    // const newrow = document.createElement('tr');                 // i started making something to manually input new entries but haven't done much
    ...
    extrasTable.innerHTML = "";   // adding in total and other semi-extra stuff
